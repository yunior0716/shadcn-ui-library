        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              {/* User Avatar */}
              <Avatar>
                <AvatarImage src="/images/deliodiaz.jpeg" alt="User avatar" />
      ...
      <div className="flex overflow-hidden bg-white pt-16 dark:bg-slate-900">
                ...
                <ul className="space-y-2 pb-2">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:bg-slate-900 dark:hover:bg-slate-700 dark:text-slate-300 "
                      >
        ...
        <div
          className={`bg-gray-900 opacity-50 ${
            isSidebarOpen ? 'block' : 'hidden'
          } fixed inset-0 z-10 dark:bg-slate-300 lg:hidden`}
          id="sidebarBackdrop"
          onClick={toggleSidebar}
        ></div>
        <div
        ...
        >
          ...
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 print:hidden dark:bg-slate-900">
            <ul className="flex items-center flex-wrap mb-6 md:mb-0">
              ...
              <li>
                <a
                  href="https://deliodiaz.netlify.app"
                  target="_blank"
            ...
            <div className="flex sm:justify-center space-x-6">
              <a
                href="https://github.com/yunior0716"
                target="_blank"
